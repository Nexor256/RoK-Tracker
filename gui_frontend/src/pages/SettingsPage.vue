    ...
    <div class="mx-auto max-w-3xl flex flex-col gap-4">
          ...
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              ...
              <Button
                ...
                size="sm"
                @click="scanEmulators"
                :disabled="isScanningEmulators"
              >
                <RefreshCwIcon
                  class="w-4 h-4 mr-2"
                  :class="{ 'animate-spin': isScanningEmulators }"
                />
                Refresh
              </Button>
            </div>
            ...
            <div
              v-if="isScanningEmulators"
              class="flex items-center justify-center p-6 border rounded-md border-dashed border-border/60 bg-muted/20"
            >
              <svg
                class="mr-2 h-5 w-5 animate-spin text-muted-foreground"
            ...
            <div
              v-else-if="detectedEmulators.length === 0"
              class="flex flex-col items-center justify-center p-6 border rounded-md border-dashed border-border/60 bg-muted/20 text-center"
            >
              <span class="text-sm text-muted-foreground">No active emulators detected.</span>
              <span class="text-xs text-muted-foreground mt-1"
                >Please ensure your emulator is running, or configure it manually below.</span
              >
            </div>
            ...
            <div v-if="showManualConfig" class="p-4 pt-0 border-t border-border/60">
              <div class="grid gap-4 mt-3">
                  ...
                  <div class="space-y-1">
                    ...
                    <Select v-model="configStore.config.general.emulator">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="ld">LDPlayer</SelectItem>
                ...
                >
                  ...
                  <Input v-model="configStore.config.general.bluestacks.config" />
                </div>
        ...
        <CardContent class="grid gap-4">
          <div class="space-y-3">
            <label class="text-sm font-medium leading-none flex items-center justify-between">
              Theme Accent Color
              <span
                class="text-xs font-mono text-muted-foreground bg-muted/50 px-2 py-0.5 rounded-md border"
                >Hue: {{ configStore.themeColor }}</span
              >
            </label>
            ...
            <div class="relative pt-1 pb-2">
              ...
              />
              <div
                class="absolute -bottom-2 inset-x-0 pointer-events-none flex justify-between px-1.5"
              >
            ...
            <div class="flex flex-wrap gap-2.5 mt-2">
              <button
                ...
                :class="
                  configStore.themeColor === preset.hue
      ...
      <Card>
        ...
        <CardContent class="flex flex-col gap-4">
          ...
          <div
            class="grid grid-cols-2 gap-x-4 gap-y-3 rounded-md bg-muted/50 dark:bg-muted/10 backdrop-blur-md p-4 border border-border/60 dark:border-border/50 mt-2 shadow-sm"
          >
            <Switch
          ...
          <div
            class="flex flex-col gap-3 p-3 border border-border/60 dark:border-border/50 rounded-md bg-muted/50 dark:bg-muted/10 backdrop-blur-md mt-2 shadow-sm"
          >
            <Switch
      ...
      <Card>
        <CardHeader class="pb-3">
          ...
          <CardDescription
            >Verify governor City Hall levels after the main scan completes.</CardDescription
          >
        </CardHeader>
        <CardContent class="flex flex-col gap-4">
          <Switch
      ...
      <Card>
        <CardHeader class="pb-3">
          ...
          <CardDescription
            >Fine-tune macro delay timings to match your PC performance.</CardDescription
          >
        </CardHeader>
        <CardContent>
          <div class="grid grid-cols-2 gap-4">
